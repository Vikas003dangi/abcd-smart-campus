...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = config('SOCIAL_AUTH_GOOGLE_OAUTH2_KEY', default='').strip().strip("'").strip('"') or '729497897582-ln9h8cai5ighe13pf624goue4mmp2b1u.apps.googleusercontent.com'
